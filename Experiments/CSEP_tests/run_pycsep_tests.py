...
def main():
    ...
    if args.model == 'SMASH':
        args.forecast_dir = forecast_path + f'/SMASH/daily_forecasts/{args.dataset}'
        args.plots_path = forecast_path + f'/SMASH/daily_forecasts/{args.dataset}/plots'
        args.test_results_path = forecast_path + f'/SMASH/daily_forecasts/{args.dataset}/test_results'
        ...
        args.forecast_dir = forecast_path + f'Spatio-temporal-Diffusion-Point-Processes/daily_forecasts/{args.dataset}'
        args.plots_path = forecast_path + f'Spatio-temporal-Diffusion-Point-Processes/daily_forecasts/{args.dataset}/plots'
        args.test_results_path = forecast_path + f'Spatio-temporal-Diffusion-Point-Processes/daily_forecasts/{args.dataset}/test_results'
    ...
    args.catalog_path = forecast_path + f'/ETAS/output_data_{args.dataset}_{Mc_str}/CSEP_format_catalog.csv'
